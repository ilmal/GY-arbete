...
# dftrain = pd.read_csv('https://storage.googleapis.com/covid19-open-data/v3/epidemiology.csv') # training data
# dfeval = pd.read_csv('https://storage.googleapis.com/covid19-open-data/v3/epidemiology.csv') # testing data
...
for index in range(10):
    print("\n")
    print("Prob live: ", result[index]["probabilities"][1])
    print("Prob Death: ", result[index]["probabilities"][0])
